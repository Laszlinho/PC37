class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta: - Qual é a minha prof favorita (e a melhor)? " );
    this.question.position(150, 80);
    this.option1.html("1: Daysi " );
    this.option1.position(150, 100);
    this.option2.html("2: Deise" );
    this.option2.position(150, 120);
    this.option3.html("3: Desi" );
    this.option3.position(150, 140);
    this.option4.html("4: Daisi" );
